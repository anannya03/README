...
📖 I am currently a **Software Engineer at Microsoft**, working at the intersection of AI, developer tools and software engineering.<br><br>
🤖 My current work focuses on **AI coding agent evaluations**, analyzing benchmark runs and agent trajectories to uncover failure modes and identify opportunities to improve GitHub Copilot and VS Code.<br><br>
☁️ Previously at Microsoft, I worked on the **Azure Identity SDK** and was a core contributor to the **Azure MCP Server**. I built MCP tools for Azure services, improved how LLMs discover and select tools across 20+ Azure namespaces, developed automated E2E testing for MCP tool invocations, and helped service teams onboard their tools to the MCP ecosystem.<br><br>
🌱 I’m interested in solving complex backend engineering problems, designing scalable systems, ith a growing interest in integrating AI/ML capabilities into real-world systems.<br><br>
🎓 I have a **Master’s in Computer Science from the University of Southern California.** FIGHT ON! ✌🏻<br><br>
⚡ Outside of work, you’ll find me running, reading fiction, baking, exploring new restaurants, or getting lost in a good TV series.<br><br>
☎️ Contact me via <a href="https://www.linkedin.com/in/anannya-p-03a6a3110"><img src="https://img.shields.io/badge/LinkedIn-indigo?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn Badge"></a> or <a href="mailto:patraanannya@gmail.com"><img src="https://img.shields.io/badge/Email-pink?style=for-the-badge&logo=email&logoColor=black" alt="Email Badge"></a>, I'm always happy to chat about software engineering opportunities, interesting projects, or just grab a coffee.☕ <br><br>
...
![Vector Databases](https://img.shields.io/badge/Vector%20Databases-FF6F61?style=for-the-badge)
